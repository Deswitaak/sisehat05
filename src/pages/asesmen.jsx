    ...
    <div className="bg-[#f4f7fb] min-h-screen flex flex-col">
      ...
      <div className="px-4 md:px-8 lg:px-16 py-6 md:py-10 flex-1">
        ...
        >
          ...
          {role === "Pemilik" ? (
            <>
              Anda sedang mengisi asesmen sebagai
              <b> Pemilik Usaha</b>.
              Fokus asesmen meliputi:
              operasional usaha,
              legalitas,
              finansial,
              dan performa bisnis.
                  ...
                  <div className="flex gap-3">
                    ...
                    {current.scale.map((num) => (
                      ...
                      <button
                        ...
                        className={`w-10 h-10 border rounded-md transition
